...
class AdvancedVisualizer:
    ...
    def plot_support_resistance(self, support_resistance_data, stock_data, save=True, show=False):
        ...
        for i, (price, date) in enumerate(zip(support_levels['prices'], support_levels['dates'])):
        ...
        for i, (price, date) in enumerate(zip(resistance_levels['prices'], resistance_levels['dates'])):
